...
const Apply = () => {
  ...
  if (isSubmitted) {
    return (
      <div className="min-h-screen w-full overflow-x-hidden">
        <Navigation />
        <main className="flex flex-col w-full items-center px-4 pt-20 gap-8">
            <div className="w-full flex items-center justify-center p-8 min-h-[60vh]">
              <div className="max-w-2xl text-center w-full">
                <GlassPanel className="p-12" intensity="strong">
  ...
  return (
    <div className="min-h-screen w-full overflow-x-hidden">
      ...
      <main className="flex flex-col w-full items-center px-4 pt-20 gap-8">
        <div className="w-full flex justify-center p-8 min-h-[60vh]">
          <div className="w-full max-w-2xl">
            <div className="text-center mb-12" data-aos="fade-up">
              <h1 className="font-display text-4xl text-foreground mb-4 uppercase tracking-wide">
                Application
              </h1>
            </div>

            <div className="border border-white/10 p-8 md:p-12" data-aos="fade-up" data-aos-delay="100">
              {/* Step 1: Personal Info */}
              {currentStep === 1 && (
                ...
                <div className="space-y-8 animate-fade-in">
                  ...
                  {formData.hasStartup === "yes" && (
                    <div className="space-y-8 pt-4 animate-fade-in">
                      <div className="space-y-2">
                        <Label className="text-xs uppercase tracking-widest text-muted-foreground">Venture Name</Label>
                        <Input
                          id="startupName"
              ...
              {currentStep === 3 && (
                <div className="space-y-8 animate-fade-in">
                  ...
                  <div className="space-y-6">
                    <Label className="text-xs uppercase tracking-widest text-muted-foreground">Primary Challenge</Label>
                    <RadioGroup
                    ...
                    >
                      {[
                        ...
                        <div
                          key={option.value}
                          className="flex items-center space-x-3 p-4 border border-white/10 hover:border-white/30 transition-colors cursor-pointer"
                        >
                  ...
                  <div className="space-y-2">
                    <Label className="text-xs uppercase tracking-widest text-muted-foreground">Pitch</Label>
                    <Textarea
                      id="pitch"
                      value={formData.pitch}
                      onChange={(e) => updateFormData("pitch", e.target.value)}
                      placeholder="Briefly describe what you're building..."
                      className="bg-transparent border border-white/20 rounded-none focus-visible:ring-0 focus-visible:border-white transition-colors min-h-[150px] resize-none p-4"
                    />
                  </div>
                </div>
              )}
              ...
              {currentStep === 4 && (
                <div className="space-y-8 animate-fade-in">
                  ...
                  <div className="space-y-6">
                    <Label className="text-xs uppercase tracking-widest text-muted-foreground">Select Track</Label>
                    <RadioGroup
                    ...
                    >
                      ...
                      >
                        <RadioGroupItem
                          value="founder"
                          id="track-founder"
                          className="absolute top-6 right-6 border-white/20 text-white"
                        />
                        <Label htmlFor="track-founder" className="cursor-pointer block h-full">
                      ...
                      >
                        <RadioGroupItem
                          ...
                          className="absolute top-6 right-6 border-white/20 text-white"
                        />
                        <Label htmlFor="track-executive" className="cursor-pointer block h-full">
                          <div className="font-display text-xl text-foreground mb-2">
                            Executive
                          </div>
                          <div className="text-xs text-muted-foreground uppercase tracking-wider mb-4">
                  ...
                  <div className="flex items-start space-x-3 p-4 border border-white/5 bg-white/5">
                    <Checkbox
                      id="terms"
                    ...
                    />
                    <Label htmlFor="terms" className="font-light cursor-pointer text-sm leading-relaxed text-muted-foreground">
              ...
              <div className="flex items-center justify-between mt-12 pt-6 border-t border-white/10">
                ...
                {currentStep < 4 ? (
                  <Button
                    onClick={handleNext}
                    className="bg-white text-black hover:bg-white/90 text-xs uppercase tracking-widest px-8 rounded-none h-12"
                  >
                    Continue
                  ...
                  <Button
                    ...
                    className="bg-white text-black hover:bg-white/90 text-xs uppercase tracking-widest px-8 rounded-none h-12 disabled:opacity-50"
                  >
                    {isSubmitting ? (
                      <>
