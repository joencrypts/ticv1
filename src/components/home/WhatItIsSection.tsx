  ...
  return (
    <section className="py-16 sm:py-24 md:py-32 px-4 sm:px-6 relative bg-transparent" data-aos="fade-up" data-aos-duration="1000">
      <div className="max-w-4xl mx-auto flex flex-col items-center space-y-8 sm:space-y-12 md:space-y-16" data-aos="fade-up">
        <h1 
          className="text-xl sm:text-2xl md:text-3xl lg:text-4xl xl:text-5xl font-bold font-body tracking-wide text-center px-2 min-h-[60px] sm:min-h-[80px] bg-[linear-gradient(110deg,#939393,45%,#ffffff,55%,#939393)] bg-[length:200%_100%] animate-shine bg-clip-text text-transparent drop-shadow-[0_0_15px_rgba(255,255,255,0.3)]"
          data-aos="fade-in"
